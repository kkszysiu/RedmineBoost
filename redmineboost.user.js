...
function getRebelmouseMail(name, name1st) {
            ...
            if (!cont) {
                ...
                for (var i = 0; i < selme.childNodes.length; ++i) {
                    ...
                    if (avatars && opt.innerHTML !== '') {
                        ...
                        el.className = 'asi';
                        el.style.cssText = 'background-image:url(' + getGravatar( getRebelmouseMail(optVal, nameFirst) ) + ')';
    ...
    try {
        ...
        for (var k in col) {
            ...
            if (ahr[0]) {
                ...
                dv.style.backgroundImage = 'url(' + getGravatar( getRebelmouseMail(name,1), mediumAvatars ? 28 : 20 ) + ')';
                ahr[0].innerHTML = '';
